...
async def get_revenue_summary(property_id: str, tenant_id: str, month: int, year: int) -> Dict[str, Any]:
    """
    Fetches revenue summary for a specific month, utilizing caching to improve
    performance. The cache key includes year-month so different months never collide.
    """
