...
interface RevenueData {
    property_id: string;
    // Currency-precise decimal string from the API (e.g. "2250.00") - never a float
    total_revenue: string;
    currency: string;
    reservations_count: number;
}

// Adds thousands separators to a decimal string without ever parsing it as a float
                    ...
                    <div>
                        ...
                        <div className="flex items-baseline gap-2 mt-1">
                            <span className="text-3xl font-bold text-gray-900 tracking-tight">
                                {data.currency} {formatCurrencyString(data.total_revenue)}
                            </span>
